/**
 * Advanced Sui Faucet Validation Schemas
 * Enhanced input validation for SUI testnet token faucet
 */
...
// [validation] SUI faucet request schema - enhanced edition
export const faucetRequestSchema = Joi.object({
  ...
  address: Joi.string()
    ...
    .messages({
      'string.empty': 'Wallet address is required for SUI token request',
