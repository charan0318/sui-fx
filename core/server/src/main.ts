 ...
 * ╚══════╝ ╚═════╝ ╚═╝    ╚═╝     ╚═╝  ╚═╝ ╚═════╝  ╚═════╝╚══════╝   ╚═╝   
 * 
 * Advanced Sui Faucet DApp - Core Server
 * Enhanced testnet SUI token faucet with modern features
 * 
 * @author Sui Faucet Development Team
 * @version 2.0.0
 * @license MIT
 */
...
// [faucet] Initialize environment configuration
dotenv.config();

const app = express();
const server = createServer(app);

// [faucet] Security hardening middleware
app.use(helmet({
