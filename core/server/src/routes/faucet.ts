/**
 * Advanced Sui Faucet Routes
 * Enhanced SUI testnet token faucet API endpoints
 * 
 * Handles secure SUI token distribution with advanced rate limiting,
 * comprehensive validation, and modern monitoring features.
 */
...
/**
 * @swagger
 * /api/v2/faucet/request:
 *   post:
 *     summary: Request SUI testnet tokens from advanced faucet
 *     description: |
 *       Enhanced SUI testnet token faucet with modern features.
 *
